...
namespace RevitAPI.Wrappers
{
    public class ColumnWrapper: IElementWrapper
    {
        ...
        {
            Autodesk.Revit.DB.ElementId topLevelId = column.get_Parameter(BuiltInParameter.FAMILY_TOP_LEVEL_PARAM).AsElementId();
        ...
        {
            Autodesk.Revit.DB.ElementId baseLevelId = column.get_Parameter(BuiltInParameter.FAMILY_BASE_LEVEL_PARAM).AsElementId();
        ...
        public void CutInstance()
        {
            ...
            if (columnLocation == null) throw new System.InvalidOperationException("Cannot get location.");
